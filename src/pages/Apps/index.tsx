    ...
    <div className="w-full flex flex-col gap-4 px-4 text-blue-dark pt-6 items-center">
      ...
      <div className="flex flex-row gap-3 justify-center">
        ...
        <div className="md:text-5xl text-2xl w-full flex flex-row">
            <img src={image1Mob} alt="image" className="md:hidden mr-4 w-1/2" />
            <div>App Associado</div>
          </div>
          <div className="text-lg">
            É um aplicativo destinado ao Associado das Associações de Proteção
            Veicular, com mais de 1,9 milhões de usuários em todo país e mais de
      ...
      <div className="flex flex-row gap-3 justify-center">
        <div className="gap-4 flex flex-col md:w-1/3 h-full items-center text-end">
          <div className="md:text-5xl text-2xl w-full flex flex-row">
            ...
            <img src={image2Mob} alt="image" className="md:hidden ml-4 w-1/2" />
          </div>
          <div className="text-lg">
            É um aplicativo que surge com a premissa do ”Cadastramento Fácil em
            Tempo Real”. Desenvolvido especialmente para os consultores, o
      ...
      <div className="flex flex-row gap-3 justify-center">
        ...
        <div className="gap-4 flex flex-col md:w-1/3 h-full items-center text-start">
          <div className="md:text-5xl text-2xl w-full flex flex-row">
            <img src={image3Mob} alt="image" className="md:hidden mr-4 w-1/2" />
            <div>App Visto</div>
          </div>
          <div className="text-lg">
            Quer praticidade, comodidade e ainda permitir que o próprio
            associado realize a vistoria? Com o App Visto é possível. Conheça as
            facilidades do App Visto e tenha agilidade e total segurança na
